...
## Почему этот стек
- `Python 3.11` + `aiogram 3.x`: нативный async, удобные FSM-диалоги, быстрый Telegram API слой.
...
- CRUD-потоки для:
  - VPS (добавление, список, фильтры, поиск, карточка, архив/восстановление, избранное)
  - Оплат (добавление, истекают 7/30 дней, сводка за месяц)
  - Мануалов (категории, поиск, просмотр, добавление, редактирование/удаление для админа)
